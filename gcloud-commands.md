...
5. To create custom roles, you need to know what permissions you want to assign to this new role.
...
7. remove instance
       ...
       cloud bigtable instances delete <instance>

# SHOW QUOTAS (STATIC IP ETC)

1. Show quotas of a project

       gcloud compute project-info describe --project <name_of_project>
